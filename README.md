...
- Day 16: ✅ (part 1 done, also part 2, but is not working correctly on my input while test cases are fine... will have to look at it a bit more later; VERY FUN task though 😀 UPDATE: done!! Found a bug in literal packet parsing - well, not really a bug, just me not reading instructions closely enough 😋)
